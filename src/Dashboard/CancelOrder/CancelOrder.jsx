...
import { FiSearch, FiEye, FiUser, FiCalendar, FiCheck, FiTruck, FiX } from "react-icons/fi";
          ...
          <Table className="min-w-full">
            <Thead className="bg-brand-teal-base text-white">
              <Tr>
                ...
                <Th className="px-6 py-4 text-left">Canceled By</Th>
              ...
              {filteredOrders.reverse().map((o, i) => (
                <Tr key={o?._id} className="hover:bg-brand-cream/30 transition-colors">
                  ...
                  <Td className="px-4 py-3">
                    ...
                    <div className="text-sm text-brand-gray-base md:hidden">{o?.user?.mobile}</div>
                  </Td>
                  ...
                  <Td className="px-4 py-3 whitespace-nowrap">
                    <div className="text-brand-gray-base">
                      ...
                      <p className="text-xs text-brand-orange-base">{o?.cancelBy?.cancelledTime}</p>
                    </div>
                  </Td>
                  <Td className="px-4 py-3 whitespace-nowrap">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                  ...
                  <div className="bg-brand-cream/30 p-4 rounded-lg">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-lg font-medium text-brand-teal-base">Cancellation Info</h3>
                    </div>
                    <div className="space-y-2 pl-11">
                      <p><span className="font-medium text-brand-gray-base">Canceled By:</span> {selectedOrder.cancelBy?.name}</p>
                      <p><span className="font-medium text-brand-gray-base">Canceled Time:</span> {selectedOrder.cancelBy?.cancelledTime}</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-brand-cream/30 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 pl-11">
                      <p><span className="font-medium text-brand-gray-base">Approved By:</span> {selectedOrder.approvedBy?.name}</p>
                      <p><span className="font-medium text-brand-gray-base">Approval Time:</span> {selectedOrder.approvedBy?.approvedTime}</p>
                    </div>
                  </div>
                </div>
