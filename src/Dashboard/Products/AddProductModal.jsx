      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {subCategories.map((item, i) => (
                <div key={i} className="flex flex-wrap gap-2 items-center">
                  <input
                    value={item}
                    onChange={(e) =>
                      updateArray(setSubCategories)(i, e.target.value)
                    }
                    className="input input-bordered flex-1 min-w-[150px]"
                  />
                  <button
                    type="button"
                    onClick={() => removeFromArray(setSubCategories)(i)}
            ...
            <button
              type="button"
              onClick={addToArray(setSubCategories)}
            ...
            <div className="space-y-2">
              {variants.map((v, i) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => removeFromArray(setVariants)(i)}
                    className="btn btn-sm btn-warning col-span-2 md:col-span-1"
                  >
                    ✕ Remove
                  </button>
                </div>
            ...
            <button
              type="button"
              onClick={addToArray(setVariants, {
                sku: "",
                name: "",
                price: "",
                stock_quantity: "",
              ...
              <div className="space-y-2">
                {ingredients.map((item, i) => (
                  <div key={i} className="flex flex-wrap gap-2 items-center">
                    ...
                    <button
                      type="button"
                      onClick={() => removeFromArray(setIngredients)(i)}
                      className="btn btn-sm btn-warning"
                    >
                      ✕
                    </button>
              ...
              <div className="space-y-2">
                {uses.map((item, i) => (
                  <div key={i} className="flex flex-wrap gap-2 items-center">
                    <input
                      value={item}
                      onChange={(e) => updateArray(setUses)(i, e.target.value)}
                      className="input input-bordered flex-1 min-w-[150px]"
                    />
                    <button
                      type="button"
                      onClick={() => removeFromArray(setUses)(i)}
                      className="btn btn-sm btn-warning"
                    >
                      ✕
                    </button>
              ...
              <div className="space-y-2">
                {images.map((url, i) => (
                  <div key={i} className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => removeFromArray(setImages)(i)}
                      className="btn btn-sm btn-warning"
                    >
                      ✕
                    </button>
