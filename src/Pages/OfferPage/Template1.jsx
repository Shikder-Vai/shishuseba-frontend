  ...
  return (
    <div className="bg-gray-50 font-sans min-h-screen">
      ...
      <main className="container mx-auto max-w-4xl px-6 lg:px-0 pt-8">
        {/* Features Section */}
        {features && features.list && features.list.length > 0 && (
        ...
        {specifications && specifications.list && specifications.list.length > 0 && (
          <section className="my-12 sm:my-16">
        ...
        {whyChooseUs && whyChooseUs.list && whyChooseUs.list.length > 0 && (
